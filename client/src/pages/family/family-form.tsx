...
export default function FamilyFormPage({
  ...
  const onSubmit = (data: FormData) => {
    console.log("Form submit triggered", { mode, data, canAddDelete });

    // Check permissions before attempting to save
    if (mode === "create" && !canAddDelete) {
      console.log("Permission denied for family creation");
      toast({
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className={styles.form}>
            ...
            <div className={styles.actions}>
              ...
              <Button
                ...
                onClick={() => {
                  console.log("Save button clicked", { mode, isPending: saveMutation.isPending, canAddDelete });
