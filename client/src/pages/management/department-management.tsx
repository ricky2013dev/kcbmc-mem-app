                ...
                <CardHeader className="pb-3">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-1 sm:gap-2" onClick={() => toggleDepartmentExpansion(department.id)}>
                        <Button
                          variant="ghost"
                          size="sm"
                      ...
                      {departmentTeams.map((team) => {
                        ...
                        return (
                          <div key={team.id} className="border-l-2 border-muted pl-4 py-2">
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                <div className="flex items-center gap-1 sm:gap-2" onClick={() => toggleTeamExpansion(team.id)}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
