      ...
      <div className={styles.main}>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className={styles.form}>
            {/* Fixed Header with Family Name and Visited Date */}
            <Card className="mb-2">
                ...
                <div className="grid grid-cols-2 gap-4 items-end">
                  <div>
                   <Input
                      ...
                      readOnly
                      className="bg-muted text-lg font-semibold text-primary mt-1"
                  ...
                  {mode === "edit" && family?.familyCode && (
                    <div className="md:col-span-2">
                      ...
                      <Input
                        ...
                        readOnly
                        className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200 text-blue-800 font-mono font-semibold mt-1"
            ...
            <Tabs defaultValue="husband" className="w-full">
              <TabsList className="grid w-full grid-cols-3 md:grid-cols-6 grid-rows-2 md:grid-rows-1 gap-y-2 md:gap-y-0">
                <TabsTrigger className="mb-2" value="husband">Husband</TabsTrigger>
                <TabsTrigger className="mb-2" value="wife">Wife</TabsTrigger>
                <TabsTrigger className="mb-2" value="basic">Basic </TabsTrigger>
              ...
              <CardContent className={styles.sectionContent}>
                <div className={styles.grid}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>방문/등록 (Member Status)</FormLabel>
                        <Select
